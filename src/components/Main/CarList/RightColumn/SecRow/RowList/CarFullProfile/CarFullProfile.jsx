      ...
      <div className={s.wrapper}>
        <div className={s.car_profile_wrap}>
            ...
            <div className={s.head_tools}>
              <div   className={s.head_tool}>
                <button
                  ...
                  id={`${id}-bookmark`}
                  className={inBookmark? s.added__to_bookmark_btn: s.deleted_bookmark}
                ></button>
                <label
                  htmlFor={`${id}-bookmark`}
          ...
          <div className={s.car_info_wrap}>
            <div className={s.car_img_c}>
              <div className={s.main_img_wrpa}>
                <img src={imgNumber===1 ?bugatti_img :imgNumber===2?bugatti_side_img:imgNumber===3 ?bugatti_back_img:imgNumber===4?bugatti_side_img:''} alt="" className={s.main_img} />
              </div>
            ...
            <div className={s.bid_c}>
              ...
              <div className={s.common_inf}>
                <div className={s.common_inf_list}>
                  ...
                  <div className={s.inf_property_row}>
                    <span className={s.inf_property_title}>Порт назначени</span>
                    <span className={s.inf_property_value}>Минск </span>
                  </div>
                  <div className={s.inf_property_row}>
                    <span className={s.inf_property_title}>Место назначения</span>
                ...
                <span className={s.common_logo}>
                  <img src={transport_logo} alt="" className={s.common_logo_img} />
                </span>
              </div>
            </div>
          </div>
