...
function CarProfile({img,id,favourite,year,marka,model,volume,odometr,data,now_price,show_button_buy_now}) {
    ...
    return (
      <div className={s.car_profile_row}>
        ...
        <Link  to='CarFullProfile/1' ><img src={img?img:blackMers_png} className={s.car_ava_img} /> </Link>
          <button onClick={()=>onSetBookMarkStatus(id,favourite)} className={favourite?s.added_to_bookmark:s.delete_bookmark}></button>
        </div>
